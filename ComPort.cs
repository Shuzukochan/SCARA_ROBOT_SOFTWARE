...
namespace SCARA_ROBOT_SOFTWARE
{
    public partial class ComPort : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select both COM port and baudrate.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            try
            {
                ...
                MessageBox.Show($"Connected to {selectedPort} at {selectedBaudrate} baud.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
